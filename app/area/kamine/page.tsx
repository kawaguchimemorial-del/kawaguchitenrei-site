...
export const metadata: Metadata = {
  title: areaKamine.metaTitle,
  description: areaKamine.metaDescription,
  alternates: { canonical: `/area/${areaKamine.slug}/` },
  openGraph: {
    title: areaKamine.metaTitle,
    description: areaKamine.metaDescription,
    url: `/area/${areaKamine.slug}/`,
    type: "article",
    images: [
      {
...
const faqJsonLd = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  mainEntity: areaKamine.faqs.map((f) => ({
    "@type": "Question",
    name: f.q,
    acceptedAnswer: {
      "@type": "Answer",
...
const funeralHomeJsonLd = {
  ...
  description:
    "川口市神根周辺で葬儀・家族葬・直葬・一日葬を承る葬儀社。自社式場「川口メモリアルホール」(川口市西新井宿)を中心に、ご搬送・ご安置・葬儀式・川口市めぐりの森での火葬まで一貫してサポートします。",
};
...
export default function KamineAreaPage() {
  return (
    <>
      <script
      ...
      <AreaDetailIntro area={areaKamine} />
      <AreaPrimaryHall
        area={areaKamine}
        description="神根エリアの住宅地から、お車でご来館いただける川口典礼の自社ホール。1日1組貸切の落ち着いた式場で、家族葬・一日葬に適しています。"
      />
      <AreaFeatures area={areaKamine} />
      <AreaPlans area={areaKamine} />
      <AreaSaijo area={areaKamine} />
