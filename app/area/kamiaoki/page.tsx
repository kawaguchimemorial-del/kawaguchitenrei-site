...
export const metadata: Metadata = {
  title: areaKamiaoki.metaTitle,
  description: areaKamiaoki.metaDescription,
  alternates: { canonical: `/area/${areaKamiaoki.slug}/` },
  openGraph: {
    title: areaKamiaoki.metaTitle,
    description: areaKamiaoki.metaDescription,
    url: `/area/${areaKamiaoki.slug}/`,
    type: "article",
    images: [
      {
...
const faqJsonLd = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  mainEntity: areaKamiaoki.faqs.map((f) => ({
    "@type": "Question",
    name: f.q,
    acceptedAnswer: {
      "@type": "Answer",
...
const funeralHomeJsonLd = {
  ...
  description:
    "川口市上青木周辺で葬儀・家族葬・直葬・一日葬を承る葬儀社。自社式場「川口メモリアルホール」(川口市西新井宿)を中心に、ご搬送・ご安置・葬儀式・川口市めぐりの森での火葬まで一貫してサポートします。",
};
...
const relatedLinks = [
  ...
  },
  {
    ...
    description: "上青木・青木エリアで利用できる寺院会館・民営式場の候補もご案内します。",
...
export default function KamiaokiAreaPage() {
  return (
    <>
      <script
      ...
      <AreaDetailIntro area={areaKamiaoki} />
      <AreaPrimaryHall
        area={areaKamiaoki}
        description="上青木エリアの住宅地から、お車でご来館いただける川口典礼の自社ホール。1日1組貸切の落ち着いた式場で、家族葬・一日葬に適しています。"
      />
      <AreaFeatures area={areaKamiaoki} />
      <AreaPlans area={areaKamiaoki} />
      <AreaSaijo area={areaKamiaoki} />
      ...
      <AreaDetailCta area={areaKamiaoki} />
    </>
  );
}
