...
export const metadata: Metadata = {
  title: "葬儀プランと料金一覧｜直葬・一日葬・家族葬・市民葬｜川口典礼",
  description:
    "川口典礼の直葬・花入れお別れ・一日葬・夕暮れ家族葬・家族葬・市民葬の6プランの料金（税込）と内容をご紹介します。費用や日数・参列人数の比較、依頼前に確認したいこともまとめています。",
  ...
  return (
    <>
      ...
      <PageHero
        ...
        description={
          <p>
            川口典礼では、直葬・花入れお別れ・一日葬・夕暮れ家族葬・家族葬・市民葬の6つの葬儀プランをご用意しています。費用や日数、参列人数の目安からご家族に合うかたちをご検討いただけます。
          </p>
        }
        breadcrumbs={[
          { label: "ホーム", href: "/" },
