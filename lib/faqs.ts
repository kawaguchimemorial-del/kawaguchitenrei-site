...
export const faqCategories: FaqCategory[] = [
  ...
  },
  {
    slug: "format",
    title: "葬儀形式・プラン",
    description: "家族葬・一日葬・直葬・市民葬の違いとプラン選びについて。",
  },
  {
    slug: "hall",
    title: "斎場・施設",
...
export const faqs: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "はい。川口典礼は24時間365日お電話を受け付けており、川口市内や近隣の病院・施設・ご自宅へ寝台車でお迎えに伺います。搬送先は川口メモリアルホール(川口市西新井宿)の安置室かご自宅をお選びいただけます。現在いらっしゃる場所をお伝えいただければ、搬送先のご相談も含めてすぐに手配を進めます。",
  },
  {
  ...
  // 費用・お見積もり
  {
    ...
    answer:
      "川口典礼の家族葬プランは、事前相談会員価格528,000円(税込)、通常価格628,000円(税込)で、参列10〜30名が目安です。ご搬送・ご安置・棺・骨壺・祭壇の基本設え・通夜と告別式のお手伝い・霊柩車・役所手続きの代行が含まれ、自社式場の川口メモリアルホールを使う場合は式場使用料がかかりません。火葬料(川口市めぐりの森は市民30,000円)、お料理・返礼品、宗教者へのお礼は別途で、総額は事前のご相談(無料)でお見積りします。",
  },
  {
    id: "cost-cremation",
    categorySlug: "cost",
    question: "直葬プランの費用はいくらですか？",
    answer:
      "直葬プランは、通夜・告別式などの宗教儀礼を行わず、火葬を中心にシンプルにお見送りする形式です。家族葬に比べて費用を抑えられます。火葬料金や安置日数などにより総額は変動するため、具体的な金額は概算見積りでご確認いただけます。",
  },
  {
    id: "additional-fees",
    categorySlug: "cost",
    ...
    answer:
      "ご安置日数、火葬場、式場使用料(川口メモリアルホール以外を利用する場合)、お料理、返礼品、宗教者へのお礼、搬送距離などにより別途費用が発生する場合があります。事前にわかる範囲でご案内します。",
  },
  {
    id: "cost-payment",
    categorySlug: "cost",
  ...
  // 葬儀形式・プラン
  {
    ...
    answer:
      "ご参列人数、式の規模、宗教者のお勤め、ご予算などのご希望をうかがって、ご家族に合うかたちを一緒に整えていきます。川口典礼では少人数の家族葬から最大200名規模の一般葬まで対応していますので、規模で迷ったら事前相談でお気軽にお話しください。",
  },
  {
  ...
  },
  {
    ...
    categorySlug: "format",
    question: "直葬とはどのような形式ですか？",
    answer:
      "直葬は、通夜・告別式を行わず、火葬を中心にお見送りするシンプルな形式です。当社では直葬プランとして、搬送・安置・火葬の手配まで必要な内容を整えてご案内します。",
  },
  {
    id: "cremation-only",
    categorySlug: "format",
    question: "火葬を中心としたシンプルなお見送りも相談できますか？",
    answer:
      "はい。川口典礼では、通夜・告別式を行わない直葬プラン(事前相談会員価格139,000円・通常価格189,000円、いずれも税込)と、火葬前にお花を手向けるお別れの時間を設ける花入れお別れプラン(事前相談会員価格229,000円・通常価格279,000円、いずれも税込)をご用意しています。いずれも川口市めぐりの森などの火葬場で火葬を行い、ご家族の事情に合わせて必要な手配のみ整えます。",
  },
  {
    id: "format-religious",
    categorySlug: "format",
  ...
  },
  {
    ...
    answer:
      "川口市めぐりの森は火葬を行う施設で、通夜・告別式を行う葬儀式場は併設されていません。葬儀式やお別れの時間は川口メモリアルホールなどで行い、その後、川口市めぐりの森で火葬を行う流れになります。川口典礼では、式場でのお別れから火葬場への移動まで一貫してお手伝いします。",
  },
  {
    id: "hall-other-saijo",
    categorySlug: "hall",
  ...
  },
  {
    id: "hall-parking",
    categorySlug: "hall",
    question: "駐車場は何台分ありますか？",
    answer:
      "川口メモリアルホール敷地内に70台分の駐車スペースをご用意しています。一般葬・大規模葬でも、参列の方がお車でお越しいただけます。利用は無料です。さらに参列人数が多い場合は近隣の駐車場のご案内も可能です。",
  },
  {
  ...
  // 事前相談・ご準備
  {
    ...
    answer:
      "はい。川口典礼では、ご相談・お見積り・川口メモリアルホールの見学を無料で承っています。事前相談会員にご登録いただくと、各プランを事前相談会員価格でご案内します(例:家族葬プラン628,000円→528,000円、いずれも税込)。費用や流れだけ知っておきたい、というご相談も歓迎しています。",
  },
  {
    id: "preconsult-flow",
    categorySlug: "preconsult",
