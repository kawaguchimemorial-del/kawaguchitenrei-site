...
export const faqs: FaqItem[] = [
  ...
  // 費用・お見積もり
  {
    ...
    answer:
      "ご参列人数、式場、お料理・返礼品、宗教者の有無などにより総額は変わります。少人数の家族葬から最大200名規模の一般葬まで、ご家族のご希望に合わせてご案内します。詳しくは事前のご相談で個別にご案内します(無料)。",
  },
  {
    id: "cost-cremation",
    categorySlug: "cost",
  ...
  },
  {
    ...
    answer:
      "通夜や告別式を行わない直葬プランや、火葬前にお花を手向ける花入れお別れプランなど、シンプルなお見送りにも対応しています。ご家族の事情に合わせて、必要な手配のみ整えます。",
  },
  {
    id: "format-religious",
    categorySlug: "format",
