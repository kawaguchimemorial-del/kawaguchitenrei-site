...
export const faqs: FaqItem[] = [
  ...
  },
  {
    id: "cost-cremation",
    categorySlug: "cost",
    question: "火葬を中心とした葬儀(直葬・火葬式)の費用はいくらですか？",
    answer:
      "直葬プランや火葬式と呼ばれる、宗教儀礼を行わずシンプルにお見送りする形式は、家族葬に比べて費用を抑えられます。火葬料金や安置日数などにより総額は変動します。具体的な金額は概算見積りでご確認いただけます。",
  },
  {
    id: "additional-fees",
    categorySlug: "cost",
  ...
  },
  {
    ...
    answer:
      "火葬式は火葬を中心としたシンプルな葬儀で、白木位牌や祭壇など必要なものはご用意します。当社の主要プランとしては直葬プランをご案内しており、火葬式と同義に近い形でお手伝いが可能です。直葬はさらに簡素化し、儀式に関わるものを最小限にした形式です。費用や内容を相談しながらお決めいただけます。",
  },
  {
    id: "cremation-only",
    categorySlug: "format",
