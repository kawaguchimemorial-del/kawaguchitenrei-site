...
export const saijoMegurinomori: Saijo = {
  ...
  intro: "川口市が運営する火葬場・斎場。川口典礼ではめぐりの森を利用したご葬儀をお手伝いしています。",
  description:
    "川口市めぐりの森は、川口市が運営する公営の火葬場・斎場です。火葬と式を1つの施設で執り行えるため、ご家族やご親族の移動の負担を抑えられます。川口典礼では、めぐりの森を利用した火葬式・一日葬・家族葬のご相談から手配、当日のお手伝いまで承っています。",
  features: [
    "川口市が運営する公営施設",
    "火葬と式を1つの施設で完結できる",
    "川口市民は利用料の優遇あり(要確認)",
  ...
  access: {
    fromKawaguchi: "川口典礼(川口市西新井宿)から車で約○分(要確認)",
    stations: ["最寄駅○○(要確認)"],
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "可能です。例えば、川口メモリアルホールでのご安置・打合せ・通夜を行い、翌日にめぐりの森で告別式・火葬を執り行う、といった組み合わせもご案内できます。",
    },
  ],
