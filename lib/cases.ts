...
export const cases: CaseRecord[] = [
  {
    ...
    metaDescription:
      "川口メモリアルホールで20名の一日葬を執り行った事例。仏式・費用は事前相談でご案内。川口典礼の一日葬は通夜を行わず告別式と火葬を一日で。内容をご紹介します。",
  },
  {
    slug: "5-cremation-megurinomori",
    title: "川口市めぐりの森を利用した、5名の直葬",
    summary:
    ...
    implementation:
      "宗教儀礼を行わない直葬プランをご提案しました。ご逝去当日に病院からご安置までご搬送し、翌日に川口市めぐりの森で火葬とお別れの時間をご案内しました。火葬炉前ではご家族でお花を手向け、お見送りいただきました。",
    staffComment:
    ...
    relatedPlanSlugs: ["direct-funeral"],
    relatedAreaSlugs: ["kawaguchi"],
    metaDescription:
      "川口市めぐりの森を利用した5名の直葬の事例。無宗教・費用は事前相談でご案内。川口典礼ならめぐりの森での葬儀手配を一貫してお手伝いします。",
  },
  {
    ...
    relatedAreaSlugs: ["kawaguchi", "araijuku"],
    metaDescription:
      "川口メモリアルホールで30名の家族葬を執り行った事例。仏式・費用は事前相談でご案内。通夜・告別式の二日構成。川口典礼の家族葬の流れをご紹介。",
  },
  {
    ...
    relatedAreaSlugs: ["kawaguchi", "araijuku"],
    metaDescription:
      "ご自宅安置から始まる8名の直葬の事例。無宗教・費用は事前相談でご案内。川口典礼ならご自宅でのお別れの時間にも丁寧に対応します。",
  },
];
